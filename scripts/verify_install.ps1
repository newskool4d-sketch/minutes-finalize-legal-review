...
$required = @('SKILL.md', 'VERSION', 'agents\openai.yaml', 'profiles\README.md', 'references\checklist.md', 'scripts\apply_approved_edits.py', 'scripts\render_legal_review_report.py')
